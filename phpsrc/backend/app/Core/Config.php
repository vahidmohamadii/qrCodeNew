...
final class Config
{
    ...
    public static function load(string $basePath): void
    {
        ...
        self::$values = [
            'APP_ENV' => 'production',
            'APP_DEBUG' => 'false',
            'APP_URL' => 'https://namelenam.com',
            'PUBLIC_BASE_URL' => 'https://namelenam.com',
            'CORS_ALLOWED_ORIGINS' => 'https://namelenam.com,https://www.namelenam.com',
            'DB_HOST' => '127.0.0.1',
            'DB_PORT' => '3306',
    ...
    {
        $publicPath = self::get('PUBLIC_PATH');
        $root = is_string($publicPath) && trim($publicPath) !== ''
            ? rtrim($publicPath, '/\\')
            : self::basePath('public');

        return $root . ($append === '' ? '' : DIRECTORY_SEPARATOR . ltrim($append, '/\\'));
    }
}
